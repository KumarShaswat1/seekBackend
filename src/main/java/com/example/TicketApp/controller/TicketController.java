...
public class TicketController {
    ...
    @GetMapping("/search")
    public ResponseEntity<Map<String, Object>> searchTickets(@RequestParam long userId, @RequestParam String role,
                                                             @RequestParam String status, @RequestParam String category) {
        Map<String, Object> response = new HashMap<>();
        try {
            List<SimpleTicketDTO> filteredTickets = ticketService.getFilteredTickets(userId, role, status, category);
            response.put("status", "success");
            response.put("data", Collections.singletonMap("tickets", filteredTickets));
    ...
    public ResponseEntity<Map<String, Object>> searchTicket(@PathVariable long userId, @PathVariable long ticketId) {
        Map<String, Object> response = new HashMap<>();

        try {
            // Fetch the TicketDTO using the service method
            TicketDTO ticketDTO = ticketService.searchTicket(userId, ticketId);
            response.put("status", "success");
